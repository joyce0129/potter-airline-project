...
# create a normal flight for testing
def make_flight(
    flight_id="TEST100",
    origin="YYZ",
    destination="YVR",
...
def cannot_equal_destination():
    try:
        make_flight(origin="YYZ", destination="YYZ")
...
def capacity_cannot_be_zero():
    try:
        make_flight(capacity=0, seats_remaining=0)
...
def capacity_cannot_be_negative():
    try:
        make_flight(capacity=-100, seats_remaining=0)
...
def seats_cannot_exceed_capacity():
    try:
        make_flight(seats_remaining=101, capacity=100)
...
def cannot_sell_zero_seats():
    flight = make_flight(seats_remaining=10)
...
def cannot_sell_more_than_remaining():
    flight = make_flight(seats_remaining=5)
...
def cannot_sell_sold_out_flight():
    flight = make_flight(seats_remaining=0)
...
def can_sell_last_seat():
    flight = make_flight(seats_remaining=1)
    flight.sell_seats(1)

    if flight.seats_remaining == 0:
        print("PASSED: last seat can be sold")
    else:
        print("FAILED: last seat can be sold")


# time factor tests

def cannot_price_departure_today():
    flight = make_flight(days_until=0)
...
def cannot_price_past_flight():
    flight = make_flight(days_until=-1)
...
def three_day_boundary():
    flight = make_flight(days_until=3)

    if flight.time_factor() == 1.5:
        print("PASSED: 3 day boundary")
    else:
        print("FAILED: 3 day boundary")


def four_day_boundary():
    flight = make_flight(days_until=4)

    if flight.time_factor() == 1.35:
        print("PASSED: 4 day boundary")
    else:
        print("FAILED: 4 day boundary")


def seven_day_boundary():
    flight = make_flight(days_until=7)

    if flight.time_factor() == 1.35:
        print("PASSED: 7 day boundary")
    else:
        print("FAILED: 7 day boundary")


def eight_day_boundary():
    flight = make_flight(days_until=8)

    if flight.time_factor() == 1.1:
        print("PASSED: 8 day boundary")
    else:
        print("FAILED: 8 day boundary")


def fourteen_day_boundary():
    flight = make_flight(days_until=14)

    if flight.time_factor() == 1.1:
        print("PASSED: 14 day boundary")
    else:
        print("FAILED: 14 day boundary")


def fifteen_day_boundary():
    flight = make_flight(days_until=15)

    if flight.time_factor() == 1:
        print("PASSED: 15 day boundary")
    else:
        print("FAILED: 15 day boundary")
...
def empty_plane_capacity():
    ...
    if flight.capacity_factor() == 0.85:
        print("PASSED: empty plane capacity factor")
    else:
        print("FAILED: empty plane capacity factor")
...
def full_plane_capacity():
    ...
    if flight.capacity_factor() == 1.35:
        print("PASSED: full plane capacity factor")
    else:
        print("FAILED: full plane capacity factor")
